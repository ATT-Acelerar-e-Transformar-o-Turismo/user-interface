  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute right-0 bottom-0 left-0 pointer-events-none" style={{ top: 'var(--navbar-height)' }}>
        ...
        <div className="absolute top-[5%] right-[2%] w-[35%] max-w-[440px] h-[32%] rounded-[15px] shadow-lg hidden xl:block pointer-events-auto" data-aos="fade-left" data-aos-delay="200">
          <img src={imgRectangle66} alt="" className="w-full h-full object-cover rounded-[15px]" />
        </div>

        {/* Image 2 (Bottom Left of image area — portrait) */}
        <div className="absolute top-[42%] right-[22%] w-[25%] max-w-[300px] h-[45%] rounded-[15px] shadow-lg hidden xl:block pointer-events-auto" data-aos="fade-up" data-aos-delay="350">
          <img src={imgRectangle65} alt="" className="w-full h-full object-cover rounded-[15px]" />
        </div>

        {/* Image 3 (Bottom Right — small square) */}
        <div className="absolute top-[42%] right-[2%] w-[18%] max-w-[220px] h-[35%] rounded-[15px] shadow-lg hidden xl:block pointer-events-auto" data-aos="fade-left" data-aos-delay="500">
          <img src={imgRectangle69} alt="" className="w-full h-full object-cover rounded-[15px]" />
        </div>
      </div>

      {/* Main Content Container */}
      <div className="relative max-w-[1512px] mx-auto px-4 sm:px-12 min-h-0 sm:h-auto sm:min-h-[900px] flex flex-col sm:justify-center pb-8 sm:pb-0">

        {/* Title Section — constrained to left half on xl to avoid overlapping images */}
        <div className="relative z-20 flex flex-col items-start text-left pt-20 xl:max-w-[55%]">
          {/* "A Raíz Da" */}
        ...
        <div className="relative z-10 w-full flex flex-col items-start mt-4 sm:mt-12">
          {/* Subtitle */}
          <div className="ml-2 mb-6 sm:mb-12 max-w-[600px]" data-aos="fade-up" data-aos-delay="300">

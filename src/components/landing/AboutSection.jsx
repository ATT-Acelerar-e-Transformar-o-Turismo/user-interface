...
export default function AboutSection() {
  ...
  return (
    <div className="relative w-full py-16 lg:py-32 overflow-hidden">
      <div className="max-w-[1512px] mx-auto px-4 md:px-8 lg:px-12 relative flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-2 lg:grid-cols-12 lg:grid-rows-2 gap-3 lg:gap-4 h-[300px] lg:h-[600px] xl:h-[800px]">
           {/* Image 1: Top Left */}
           <div className="lg:row-start-1 lg:col-span-5 rounded-[16px] shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="0">
             <img src={imgRectangle70} alt="" className="w-full h-full object-cover" />
           </div>

           {/* Image 2: Top Right */}
           <div className="lg:row-start-1 lg:col-span-7 rounded-[16px] shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="150">
             <img src={imgRectangle72} alt="" className="w-full h-full object-cover" />
           </div>

           {/* Image 3: Bottom Left */}
           <div className="lg:row-start-2 lg:col-span-8 rounded-[16px] shadow-xl overflow-hidden" data-aos="fade-up" data-aos-delay="300">
             <img src={imgRectangle73} alt="" className="w-full h-full object-cover lg:scale-150" />
           </div>

           {/* Image 4: Bottom Right */}
           <div className="lg:row-start-2 lg:col-span-4 rounded-[16px] shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="200">
        ...
        <div className="w-full lg:w-1/2 lg:min-w-[575px] flex flex-col justify-center text-white z-10">
          ...
          <div className="text-center lg:text-right" data-aos="fade-left" data-aos-delay="250" data-aos-offset="-100">

        ...
        {file ? (
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center">
              <svg className="w-8 h-8 text-[#00855d]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {!disabled && (
              <button
                ...
                className="font-['Onest',sans-serif] text-sm text-red-600 hover:text-red-700 transition-colors"
              >
                Remover ficheiro
              </button>
            )}
